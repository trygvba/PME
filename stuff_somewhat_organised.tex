...
\begin{enumerate}[a)]
	...
	\label{exist_cond3}
		\begin{cases}
			\nu\xi^2 \leq \frac{\partial a_i(x,t,u,p)}{\partial p_j}\xi_i \xi_j \leq \mu \xi^2, \quad \nu > 0 \\
	...
	\item For $(x,t) \in \overline{Q}_T$, $|u| \leq M$ and $|p| \leq M_1$, the functions $a_i$, $a$, $\frac{\partial a_i}{\partial p_j}$, $\frac{\partial a_i}{\partial u}$, and $\frac{\partial a_i}{\partial x_i}$ are continuous functions satisfying a H\H{o}lder condition in $x$, $t$, $u$ and $p$ with exponents $\beta$, $\frac{\beta}{2}$, $\beta$ and $\beta$ respectively.
...
\subsection{This existence result applied to our problem}
