...
With $\Phi$ strictly increasing, $Z$ is strictly increasing, and thus permits and inverse. Furthermore $Z_n^{-1}$ converges to $Z^{-1}$ uniformly on compact sets.
\end{proposition}
\begin{proof}
...
\end{equation*}
The only way this can be $0$ is if $\Phi' = 0$ a.e. everywhere on $(t,u)$, but if that were the case then $\Phi(u) = \Phi(t)$, in contradiction with $\Phi$ being strictly increasing. So $Z$ is strictly increasing, and has continuous and strictly increasing inverse $Z^{-1}$.
